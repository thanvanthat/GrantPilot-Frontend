...
export const QUALIFICATION_STEPS = [
  'Reading opportunity requirements',
  'Comparing company capabilities',
  'Checking eligibility',
  'Identifying gaps',
  'Preparing recommendation',
];

/** Staged loading sequence shown while a (mock) analysis runs. `active` is the
 *  index of the in-progress step; steps before it render as complete. */
export function QualificationProgress({ active = 0 }) {
  return (
    <div className="mx-auto max-w-md py-4">
      <p className="mb-4 flex items-center gap-2 text-sm font-bold text-navy-900">
        <Loader2 className="h-4 w-4 animate-spin text-saffron-500" /> Analyzing opportunity…
      </p>
